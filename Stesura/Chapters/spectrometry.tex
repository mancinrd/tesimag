...
At \SI{10}{\milli\meter} from the source, in position 2, intensities for \ce{OH} decreases drastically, under $0.1\%$ of values in position 1. \ce{OH} species seems to have small lifetime or mobility, so deposition of this species is higher when closer to the target.
