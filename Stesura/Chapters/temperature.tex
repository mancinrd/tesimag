...
\begin{figure}
 ...
 \subfloat[Frame $t = \SI{25}{\second}$.]{
    \includegraphics[width=0.48\textwidth]{Images/Temperature/f5t4d4_esframe_25s.png}
 }
 \hfill
 \subfloat[$\Delta T$ profile along x direction at $t = \SI{25}{\second}$]{
    \includegraphics[width=0.48\textwidth]{Images/Temperature/f5t4d4_esprofilo_25s.png}
 }
...
\begin{figure}
 ...
 \subfloat[Average power during discharge.]{
    \includegraphics[width=0.48\textwidth]{Images/Temperature/Peff_fr.png}
 }
 \subfloat[Power relative to a single voltage pulse.]{
    \includegraphics[width=0.48\textwidth]{Images/Temperature/Ppulse_fr.png}
 }
