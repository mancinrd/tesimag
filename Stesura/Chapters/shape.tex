...
CCD camera is powered by a common voltage supply, while image intensifier MCP is powered by an high voltage supply. A delay generator triggers both instruments, with different delay times (see next section).
...
\begin{figure}
 \centering
 \subfloat[\SI{40}{\nano\second}]{
    \includegraphics[width=0.48\textwidth]{Images/Shape/esframe_eliod035_1.png}
 }
 \hfill
 \subfloat[\SI{220}{\nano\second}]{
    \includegraphics[width=0.48\textwidth]{Images/Shape/esframe_eliod035_2.png}
 }
 
 \subfloat[\SI{280}{\nano\second}]{
    \includegraphics[width=0.48\textwidth]{Images/Shape/esframe_eliod035_3.png}
 }
 \hfill
 \subfloat[\SI{380}{\nano\second}]{
    \includegraphics[width=0.48\textwidth]{Images/Shape/esframe_eliod035_4.png}
 }
...
\begin{figure}
 ...
 \subfloat[Velocities in x direction.]{
    \includegraphics[width=0.48\textwidth]{Images/Shape/elio_d035_vx.png}
 }
...
\begin{figure}
 \centering
 \subfloat[Bullet propagation \SI{160}{\nano\second}.]{
    \includegraphics[width=0.42\textwidth]{Images/Shape/elio_a40_160pic.png}
 }
 
 \subfloat[Bullet impact \SI{200}{\nano\second}.]{
    \includegraphics[width=0.42\textwidth]{Images/Shape/elio_a40_200pic.png}
 }
 
 \subfloat[Backstream \SI{260}{\nano\second}.]{
    \includegraphics[width=0.42\textwidth]{Images/Shape/elio_a40_260pic.png}
 }
...
\begin{figure}
 \centering
 \subfloat[Voltage measure.]{
    \includegraphics[width=0.43\textwidth]{Images/Shape/elio_b_V.png}
 }
 \hfill
 \subfloat[Current measure]{
    \includegraphics[width=0.43\textwidth]{Images/Shape/elio_b_i.png}
 }
 ...
 \hfill
 \subfloat[Diameter along y.]{
    \includegraphics[width=0.43\textwidth]{Images/Shape/elio_b_dy.png}
 }
 \caption{Analysis of measurement setup G with helium: conductive target positioned close to the nozzle, at \SI{22}{\milli\meter} from the electrode.}
...
\begin{figure}
 \centering
 \subfloat[Mean luminosity.]{
    \includegraphics[width=0.46\textwidth]{Images/Shape/neon_c_Im.png}
 }
 \hfill
 \subfloat[Barycenter position.]{
...
Thys analysis includes four different gases, to simulate the ones used and the main components of air: helium, neon, nitrogen and oxygen. A selection of considered reactions is presented in table \ref{tab:B+reactions}, they are taken from the archive in \emph{LxCat} \cite{LxCat}.
\begin{table}
 \centering
 \begin{tabular}{cccc}
  \toprule
...
\begin{figure}
 ...
 \hfill
 \subfloat[Drift velocity as a function of electric field.]{
